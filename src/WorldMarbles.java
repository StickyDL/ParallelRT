...
public class WorldMarbles extends WorldGenerator{
	 ...
	 */
	public WorldMarbles( int frames ){
	 ...
	 */
	public WorldMarbles( int frames, boolean colorful ){
	 ...
	 */
	public WorldMarbles( int frames, int marbles ){
	 ...
	 *            True to use colorful marbles, false to use transparent ones
	 */
	public WorldMarbles( int frames, int marbles, boolean colorful ){
	 ...
	 */
	public WorldMarbles( int frames, int marbles, boolean colorful, int seed ){
		worlds = new World[frames];
		System.out.println( "WorldMarbles( " + frames + ", " + marbles + ", " + colorful + ", " + seed + " )" );
